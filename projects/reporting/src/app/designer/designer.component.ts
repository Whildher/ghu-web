...
export class DesignerComponent implements OnInit {
  ...
  constructor(private _sreportes: SreportesService) {
   ...
   // The report name.
   reportName = "RepLayoutPlanta";
   // The backend application URL.
   host = 'http://190.85.54.78:5000/';
 
   //title = 'DXReportViewerSample';
   /*reportUrl: string = 'RptProductos';
   hostUrl: string = 'http://190.85.54.78:5000/';
   ...
   cargar(): void {
     this._sreportes.getDatos().subscribe(
       (re: any) => {
         ...
         this.datosj=re;
         this.reportUrl = 'RptProductos?'+JSON.stringify(prm);
